# Contributing to the bsdcpio cookbook

We are glad you want to contribute to the bsdcpio cookbook! The first
step is the desire to improve the project.

## Quick-contribute

* Create an issue on the github [issue tracker](https://github.com/sous-chefs/bsdcpio/issues)
